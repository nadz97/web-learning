                    ...
                    <?php foreach ($menu as $menuItem): ?>
                        <?php if (!empty($menuItem['submenu'])) { ?>
                            <div class="nav-item dropdown">
                                <a href="index.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><?php echo $menuItem['title']; ?></a>
                                <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                    <?php foreach ($menuItem['submenu'] as $subMenuItem): ?>
                                        <a href="feature.html" class="dropdown-item"> <?php echo $subMenuItem['title']; ?> </a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        <?php } else { ?>
                            <a href="index.html" class="nav-item nav-link active"> <?php echo $menuItem['title']; ?> </a>
                        <?php } ?>
